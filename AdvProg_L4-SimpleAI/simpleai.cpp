...
//Hàm này sẽ trả về ký tự xuất hiện nhiều nhất trong occurrences mà không nằm trong selectedChars
...
//Hàm này sẽ trả về một danh sách các từ trong words thỏa mãn mask và ch
