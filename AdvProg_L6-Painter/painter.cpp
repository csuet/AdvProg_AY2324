...
{
    this->color = color;// TODO: set the color value for the Painter and set Render Draw Color
}
...
void Painter::jumpForward(int numPixel)
{
    ...
    y -= numPixel * sin(angle * (M_PI / 180.0) );// TODO: jump the painter forward
}
...
{
    jumpForward(-numPixel);// TODO: jump the painter backward
}
...
{
    angle += degree;
    angle = fmod(angle,360.0);// TODO: rotate left the painter
}
...
{
     turnLeft(-degree);// TODO: rotate right the painter
}
